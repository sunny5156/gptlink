...
trait ConfigTrait
{
    ...
    public static $transfer = [
        Config::WECHAT_PLATFORM => \App\Http\Dto\Config\WechatPlatformDto::class,
        // 公众平台
        Config::WECHAT_PAYMENT => \App\Http\Dto\Config\WechatPaymentDto::class,
        // 微信支付
        Config::WECHAT_WEB => \App\Http\Dto\Config\WechatWebDto::class,
        // 微信 web 端
        Config::SMS => \App\Http\Dto\Config\SmsConfigDto::class,
        // 创蓝
        Config::WEBSITE => \App\Http\Dto\Config\WebsiteConfigDto::class,
        // 站点配置
        Config::PROTOCOL => \App\Http\Dto\Config\ProtocolDto::class,
        // 协议配置
        Config::PAYMENT => \App\Http\Dto\Config\PaymentDto::class,
        // 支付配置
        Config::KEYWORD => \App\Http\Dto\Config\KeywordDto::class,
        // 关键词配置
        Config::SHARE => \App\Http\Dto\Config\ShareConfigDto::class,
        // 分享配置
        Config::SALESMAN => \App\Http\Dto\Config\SalesmanDto::class,
        // 分销员
        Config::AI_CHAT => \App\Http\Dto\Config\AiChatConfigDto::class,
        // AI对话
        Config::AI_IMAGE => \App\Http\Dto\Config\AiImageConfigDto::class,
        // AI绘画
        Config::LOGIN => \App\Http\Dto\Config\LoginConfigDto::class,
    ];
    ...
    public static function updateOrCreateByDto(ConfigDtoInterface $dto)
    {
        ...
        return Config::query()->updateOrCreate($dto->getUniqueFillable(), $dto->getConfigFillable());
    }
    /**
     * 获取配置
     * @param $type
