...
class Package extends Model
{
    ...
    public const IDENTITY = [self::IDENTITY_USER => '用户'];
    public const TYPE_CHAT = 1;
    public const TYPE = [self::TYPE_CHAT => '对话'];
    public const CODE_NUM = 'num';
    public const CODE_DATE = 'date';
    public const CODE = [self::CODE_NUM => '按次数', self::CODE_DATE => '按天数'];
    public const SHOW_OFF = 0;
    public const SHOW_ON = 1;
    public const SHOW = [self::SHOW_OFF => '不展示', self::SHOW_ON => '展示'];
    /**
     ...
     * @var array
     */
    protected array $fillable = ['name', 'type', 'identity', 'code', 'show_name', 'show', 'sort', 'expired_day', 'num', 'price', 'level', 'platform', 'business_id'];
    /**
